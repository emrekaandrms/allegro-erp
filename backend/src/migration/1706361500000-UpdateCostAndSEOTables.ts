...
export class UpdateCostAndSEOTables1706361500000 implements MigrationInterface {
    name = 'UpdateCostAndSEOTables1706361500000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Drop existing tables
        await queryRunner.query(`DROP TABLE IF EXISTS "cost" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "seo_info" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."seo_info_platform_enum"`);

        // Create platform enum type
        await queryRunner.query(`
            CREATE TYPE "public"."seo_info_platform_enum" AS ENUM (
                'shopify',
                'etsy',
                'amazon',
                'hepsiburada',
        ...
        await queryRunner.query(`
            CREATE TABLE "seo_info" (
                "id" SERIAL NOT NULL,
                "platform" "public"."seo_info_platform_enum" NOT NULL,
